...
timeline_app.controller('ListCtrl', function($scope) {
  $scope.collectionOfDays = [
    {
      id: 1,
      datetime: new Date(2013, 5, 13, 17, 6),
      type: 'doc',
...
'JOHN SMITH, M.D.'
    ...
    {
      id: 2,
      datetime: new Date(2013, 4, 28, 12, 33),
      type: 'rad',
...
'Doe, John, MD'
    ...
    {
      id: 3,
      datetime: new Date(2013, 4, 28, 6, 40),
      type: 'lab',
...
'</div>'
    ...
    {
      id: 6,
      datetime: new Date(2013, 4, 27, 10, 20),
      type: 'rad',
...
'Bloggs, Joe, MD'
    ...
    {
      id: 7,
      datetime: new Date(2013, 4, 25, 12, 57),
      type: 'doc',
